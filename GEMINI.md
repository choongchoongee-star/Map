...
- **다중 정렬 기능:** 최신순, 좋아요순, 거리순(현재 지도 중심 기준)으로 리스트 정렬 가능.
...
### 3.4. 좋아요 및 소셜 상호작용
- **실시간 좋아요:** 하트 아이콘을 클릭하여 장소에 '좋아요' 표시 가능.
- **동기화:** Firebase RTDB의 `child_changed` 리스너를 통해 모든 사용자의 좋아요 수가 실시간으로 업데이트됨.

### 3.5. 딥 링크 (App Handoff)
